...
public class UpdateProjectVisibilityActionTest {
  ...
  private OrganizationsWsSupport wsSupport = new OrganizationsWsSupport(new OrganizationValidationImpl());
  private UpdateProjectVisibilityAction underTest = new UpdateProjectVisibilityAction(userSession, wsSupport, dbTester.getDbClient());

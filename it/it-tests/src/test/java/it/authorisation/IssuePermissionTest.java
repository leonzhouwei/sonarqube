...
import org.sonarqube.ws.client.project.ChangeVisibilityRequest;
import util.ItUtils;

import static java.util.Arrays.asList;
import static junit.framework.TestCase.fail;
import static org.assertj.core.api.Assertions.assertThat;
import static org.sonarqube.ws.client.project.ChangeVisibilityRequest.Visibility.PRIVATE;
...
public class IssuePermissionTest {
  ...
  public void init() {
    ...
    ItUtils.newAdminWsClient(orchestrator).projects().changeVisibility(new ChangeVisibilityRequest("privateProject", PRIVATE));
